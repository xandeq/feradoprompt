...
// =============================
// Pré-baixar Chromium para o PuppeteerSharp
// =============================
...
// Adiciona todos os servi�os da aplica��o via Extension
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new()
    {
        ...
        Version = "v1.0.0",
        Description = "API para gerenciamento de prompts com integra��o n8n",
        Contact = new()
        {
...
// Swagger HABILITADO EM TODOS OS AMBIENTES (incluindo produ��o)
app.UseSwagger();
app.UseSwaggerUI(options =>
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Fera do Prompt API v1");
    options.RoutePrefix = "swagger"; // Acess�vel em /swagger
    options.DocumentTitle = "Fera do Prompt API - Documenta��o";
...
// Log de inicializa��o (sem expor secrets)
...
static async Task EnsureChromiumAsync(IHostEnvironment environment)
{
    ...
    {
        throw new InvalidOperationException("Falha ao localizar o executável do Chromium baixado pelo PuppeteerSharp.");
    }
}
